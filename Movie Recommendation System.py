...
class CollaborativeFilteringRecommender:
    ...
    def __init__(self):
        ...
        """
        self.users = {
            "Yuvan": {"Inception": 5, "Interstellar": 4, "The Matrix": 3, "Bohemian Rhapsody": 2},
            "Yadu": {"Inception": 4, "The Matrix": 5, "The Dark Knight": 5, "Imagine": 3},
            "Adithya": {"Interstellar": 5, "Avengers: Endgame": 4, "Bohemian Rhapsody": 4, "Hotel California": 3},
            "Dhruv": {"The Matrix": 5, "The Dark Knight": 4, "Billie Jean": 5, "Hotel California": 4},
            "Matthew": {"Inception": 4, "Interstellar": 3, "Bohemian Rhapsody": 5, "Shape of You": 4}
        }
...
# User selects a name (e.g., Yuvan)
target_user = input('Enter Name of User:')

# Get recommendations for Yuvan
